                ...
                <div class="modal-content">
                  ...
                  {{-- Contenido del Modal Crear --}}
                      <div class="modal-body">
                        <form action=" {{route('avanceCrud.store')}} "  method="POST" enctype="multipart/form-data">
                          @csrf
                          <div class="mb-3">
                            <label for="txtNombreAvance" class="form-label">Nombre del Avance</label>
              ...
              <tr>
                ...
                <td>
                  <div class="text-center">
                    ...
                    <a href=" {{ route("avanceCrud.deletea",$item->id) }} " onclick="confirmation(event)" class="btn btn-danger btn-sm"> <i class="fa-solid fa-trash"></i> </a>
                  </div>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          {{-- Contenido del Modal Editar --}}
                              <div class="modal-body">
                                <form action="{{ route('avanceCrud.updatea', ['id' => $item->id]) }}" method="POST">
                                  @csrf
                                  @method('PUT')
                                  <div class="mb-3">
                                    
                                    <label for="avance" class="form-label">Nombre del Avance</label>
                                    <input type="text" class="form-control" id="avance" name="avance" value="{{ $item->avance }}">
