    ...
    <div style="padding: 0px 20%;" class="table-responsive">
        ...
        <div>
            ...
            <script>
              ...
              Swal.fire({
                    icon: 'warning',
                    title: '¿Estás seguro de eliminar esta plataforma?',
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Crear Nueva Plataforma</h1>
        ...
        <table class="table table-striped table-bordered table-hover border-secondary">
            ...
            <tbody>
              @foreach ($plataformaData as $item)
              <tr>
                <th>{{$item->id}}</th>
                <td>{{$item->nombre_plataforma}}</td>
                <td>
